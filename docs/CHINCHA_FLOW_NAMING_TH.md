...
- `packages/app-credits` — เครดิตในแอป + `PlatformMark` บนหัว/login (`studioLabel: CHINCHA FLOW`)
- `index.html` / `manifest.json` แต่ละแอป — ชื่อ `ชินชา · CHINCHA FLOW` / `โกอ้วน · CHINCHA FLOW`
