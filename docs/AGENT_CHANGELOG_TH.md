## 2026-06-14 — ชา: แยก 4 แท็บหลักตาม Smart POS Roadmap

- แยกเมนูงานประจำวันจาก `ขาย / หลังร้าน / บัญชี` เป็น 4 แท็บหลัก: `ขาย`, `สต๊อกแก้ว`, `สั่งของ`, `บัญชี`
- ย้าย badge รายการสั่งของค้างจากแท็บ `ops` ไปแท็บ `restock` และให้ dashboard quick link เปิดแท็บสั่งของตรง ๆ
- แท็บแอดมิน/เมเนเจอร์ด้านบนยังคงเป็นปุ่มลัดเหมือนเดิม ไม่แตะกุ้งและไม่เพิ่ม workflow ใหม่
- ถ้าพังอีกให้เช็ก `apps/chincha-tea/src/lib/navConfig.js`, `apps/chincha-tea/src/lib/teaRoles.js`, และ `apps/chincha-tea/src/App.jsx`
