...
### 2026-06-11 — ชา: ย้ายจ่ายย่อยไปหลังร้าน

- **ปัญหา/คำขอ:** แถบ `จ่ายย่อย` อยู่ในหน้าบัญชีคู่กับ `สรุปวัน` ทำให้สับสน เพราะสรุปวันเป็นหน้าที่ลูกน้องกรอกยอดรวมจากแชท/คอม ส่วนจ่ายย่อยควรเป็นรายการรายจ่ายทีละบรรทัดจากหน้าร้านหรือซื้อของเข้า
- **แก้แล้ว:** หน้าบัญชีเหลือเฉพาะ `สรุปวัน`; เพิ่ม `จ่ายย่อย` เป็นแถบใน `หลังร้าน` ข้าง `สั่งของ` และ `สต๊อกแก้ว`; ปรับข้อความช่วยเหลือให้บอกว่าใช้บันทึกรายจ่ายรายรายการและไม่ต้องลงซ้ำถ้าราคาซื้ออยู่ใน `สั่งของ` แล้ว
- **ไฟล์/จุดสำคัญ:** `OpsTab.jsx`, `SummaryTab.jsx`, `ExpensesTab.jsx`, `i18n.js`
- **พฤติกรรมหลังแก้:** ลูกน้องกรอกยอดเงินสด/โอน/แก้วใน `บัญชี > สรุปวัน`; รายจ่ายหน้าร้าน/ซื้อของเข้าไปที่ `หลังร้าน > จ่ายย่อย`
- **ถ้าพังอีก ให้เช็กก่อน:** `allowedModes` ที่ส่งเข้า `ExpensesTab` จาก `SummaryTab` และ `OpsTab`
