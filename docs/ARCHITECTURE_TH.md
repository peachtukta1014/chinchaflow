...
| `.github/workflows/` | deploy-hosting, deploy-functions, deploy-rules, pr-verify, sync-project-tree |
...
| `pr-verify.yml` | ทุก PR | smoke test + syntax check + comment ผลกลับ PR |
