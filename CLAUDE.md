...
- **ห้ามเขียน/แก้ changelog เอง** — `.github/workflows/auto-changelog.yml` เขียนให้อัตโนมัติตอน PR merge (ทั้ง `docs/AGENT_CHANGELOG_TH.md` และ `apps/<app>/CHANGELOG.md` ตามไฟล์ที่ PR แตะ) หน้าที่พี่ซีคือแค่**อ่านก่อนแก้** (ข้อด้านบน) ไม่ใช่บันทึกเอง (เดิมให้เขียนเองด้วยในทุก PR ทำให้ entry ซ้ำกับที่ workflow เขียนตอน merge — ยกเลิกแล้ว 2026-07)
