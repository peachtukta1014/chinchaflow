...
- **เปิด PR เสมอ (ห้าม draft)** — ห้าม push ตรง main ทุกกรณี พัฒนาบน branch แล้วเปิด PR **แบบปกติ (ไม่ใช่ draft)** พร้อมใส่ `[auto-merge]` ในบอดี้ — CI ตรวจผ่านแล้ว auto-merge เอง ไม่ต้องรอพีชมากด
- **บันทึกทุกการแก้** — หลัง merge แต่ละรอบ เพิ่ม entry ใน `docs/AGENT_CHANGELOG_TH.md` **และ** `apps/<app>/CHANGELOG.md` ของแอปที่เปลี่ยน
