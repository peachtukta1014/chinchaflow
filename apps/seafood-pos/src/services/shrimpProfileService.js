...
export async function uploadShrimpMemberPhoto(uid, file) {
...
export async function updateShrimpMemberProfile(uid, { name, phone }) {
  const user = requireAuthUser();
...
export async function changeShrimpMemberPassword({ currentPassword, newPassword }) {
  const user = requireAuthUser();
