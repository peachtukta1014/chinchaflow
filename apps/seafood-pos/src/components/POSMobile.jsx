...
import { Camera, CheckCircle, ChevronRight, Delete, MapPin, Mic, MicOff, PlusCircle, X } from 'lucide-react';
...
import { fsAuthHeaders, fsIncrementDebt, fsPost, fsRunQuery } from '../lib/firestoreRest';
import { hasVoiceCommitCommand, isVoiceOrderComplete, parseShrimpVoice } from '../lib/voiceParse';
import { useVoice } from '../hooks/useVoice';

// ─── POS Screen ───────────────────────────────────────────────────────────────

export const POSMobile = ({ user, stock, updateMainStock, onSaveBill }) => {
