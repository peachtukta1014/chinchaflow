...
export const CUSTOMERS = [
  ...
  { id: 'c2', name: 'ตาจุ้ยหนึ่ง', zone: 'ป่าตอง', defaultRiverSize: 'เล็ก' },
  { id: 'c3', name: 'ตาจุ้ยสอง', zone: 'ป่าตอง', defaultRiverSize: 'เล็ก' },
  { id: 'c4', name: 'น้องเล็กหนึ่ง', zone: 'ป่าตอง', defaultRiverSize: 'เล็ก' },
  { id: 'c5', name: 'ปุ้ย', zone: 'ป่าตอง', defaultRiverSize: 'เล็ก' },
  { id: 'c6', name: 'พี่แหวว,ป้าแหวว', zone: 'ป่าตอง', defaultRiverSize: 'เล็ก' },
  {
    id: 'c7',
    name: 'ร้านเฟิร์ส',
    zone: 'ป่าตอง',
    aliases: ['Firstseafood', 'เฟิร์ส', 'พี่ต้อม', 'First seafood'],
    defaultRiverSize: 'กลาง',
  },
