    ...
    >
      ...
      {cart.length > 0 && tab === 'order' && orderSection === 'order' && (
        <div className="z-20 shrink-0 px-4 pb-4 pt-2">
          ...
          >
            <span className="text-xl font-black">à¸¿{cartTotal.toLocaleString()}</span>
            <span className="text-sm font-bold bg-white/20 px-3 py-1 rounded-xl">{t('viewCart')} â</span>
          </button>
        </div>
      )}
