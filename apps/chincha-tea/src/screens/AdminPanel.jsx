...
import { getTeaRoleLabel } from '../lib/teaRoles.js';

const PROJECT_ID = FIREBASE_PROJECT_ID;

const MEMBER_ROLE_CYCLE = ['staff', 'manager', 'admin'];

function nextMemberRole(role) {
  const idx = MEMBER_ROLE_CYCLE.indexOf(role);
  return MEMBER_ROLE_CYCLE[(idx + 1) % MEMBER_ROLE_CYCLE.length];
}
