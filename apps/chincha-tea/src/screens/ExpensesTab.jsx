...
export function ExpensesTab({ member, t, lang = 'th', viewDateKey, setViewDateKey }) {
  ...
  const cupTotals = useMemo(() => {
    ...
    const preparedCups = openingCups + addedCups;
    const remainingCups = Math.max(0, preparedCups - cupsSold);
    return { openingCups, addedCups, preparedCups, cupsSold, remainingCups };
  ...
  const saveCupStock = async () => {
    ...
    try {
      ...
      await fsUpsertDoc('dailyCupStocks', cupStockDocId(dateKey), {
        ...
        preparedCups: cupTotals.preparedCups,
    ...
    <div className="px-4 pt-3 pb-8 space-y-3">
      ...
      <div className="bg-white rounded-3xl p-4 shadow-sm border border-stone-200 space-y-3">
        ...
        <div className="grid grid-cols-1 gap-2">
          ...
          <Field label={t('cupPreparedLabel')} value={cupTotals.preparedCups} suffix={t('cupPieceUnit')} readOnly highlight />
