...
export default function MemberAvatar({
  ...
  return (
    <div
      className={`${box} rounded-full border-2 border-amber-300 shrink-0 bg-gradient-to-br from-amber-600 to-amber-900 text-amber-100 font-black flex items-center justify-center ${className}`}
      aria-hidden
    >
      {initials}
    </div>
