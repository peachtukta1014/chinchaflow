...
1. มีอาการระบบผิดปกติซ่อนอยู่ — พัง/ค้าง/error/โหลดไม่ได้/ดึงไม่ได้/ไม่ตอบ/ไม่เข้าระบบ/ไม่ส่ง/ไม่ขึ้น/หายไป/แสดงผิด/เด้งออก/อัพโหลดไม่ได้ (แม้ขึ้นต้นด้วย "ทำไม", ลงท้าย "ช่วยดูหน่อย/ตรวจสอบที", หรือเป็นคำบอกเล่าต่อจากพนักงาน/ลูกค้า) → "code-action"
