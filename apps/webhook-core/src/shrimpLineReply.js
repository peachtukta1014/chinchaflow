...
const M = {
  ...
  helpCustomerTh: () => [
    ...
    '',
    `น้ำหนักต่อรายการ ${MIN_WEIGHT_KG}–${MAX_WEIGHT_KG} กก.`,
    'ยกเลิก → พิมพ์「ยกเลิก」ก่อนร้านส่ง',
    'โอนแล้ว → ส่งรูปสลิปในแชท',
  ...
  helpCustomerEn: () => [
    ...
    '',
    'How to order',
    '1) Tap「Order shrimp」— form',
    '2) Or type in this chat',
    '',
    'Examples',
    '• Peach medium 6 kg',
    ...
    'Cancel → type「ยกเลิก」before we ship',
    'Paid → send slip photo here',
