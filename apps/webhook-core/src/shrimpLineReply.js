...
const M = {
  ...
  /** ข้อความช่วยเหลือลูกค้า OA — สั้น อ่านง่าย (ไทยเป็นหลัก) */
  helpCustomerTh: () => [
    '🦐 โกอ้วน คลังซีฟู้ด',
    '',
    'เมนูด้านล่าง',
    'A 「สั่งออเดอร์」',
    'B 「ฝากสลิปยืนยันการโอน」— เลือกรูปสลิป',
    'C Help — วิธีสั่ง / ยกเลิก',
    '',
    'พิมพ์สั่งในแชท (ตัวอย่าง)',
    '• ปุ้ย กลาง 6 กก.',
    '• กุ้งแม่น้ำ 5 กก. แล้วพิมพ์ เล็ก / กลาง / ใหญ่',
    '',
    '【ยกเลิก】',
    'พิมพ์ในแชท (ก่อนร้านส่ง)',
    'ยกเลิก · ยกเลิกออเดอร์ · ยกเลิกorder · cancel · cancel order',
    '',
    'โอนแล้ว → กดเมนู B หรือส่งรูปในแชท',
    'โทร 094-940-8665 (พีช)',
    '',
    'ภาษาอังกฤษ: พิมพ์ EN',
  ].join('\n'),
  helpCustomerEn: () => [
    ...
    'Bottom menu',
    'A 「สั่งออเดอร์」— order',
    'B 「ฝากสลิปยืนยันการโอน」— upload transfer slip',
    'C Help',
    '',
    'Or type in chat (examples)',
    '• Peach medium 6 kg',
    '• River prawn 5 kg, then reply small / medium / large',
    '',
    '【Cancel】',
    'Type in chat (before we ship)',
    'ยกเลิก · ยกเลิกออเดอร์ · cancel · cancel order',
    '',
    'Paid → tap menu B or send slip photo in chat',
    'Call 094-940-8665 (Peach)',
    '',
