...
│   │   │   ├── firebase.js            # Firebase client config
│   │   │   ├── screens/               # หน้าหลัก/แท็บของร้านชา
│   │   │   │   ├── OrderTab.jsx       # POS ขายเครื่องดื่ม
│   │   │   │   ├── OpsTab.jsx         # หลังร้าน / งานปฏิบัติการ
│   │   │   │   ├── DashboardTab.jsx   # dashboard ร้านชา
│   │   │   │   ├── SummaryTab.jsx     # สรุปวัน / ปิดยอด
│   │   │   │   ├── ProfitTab.jsx      # กำไร
│   │   │   │   ├── PayrollTab.jsx     # ค่าแรง / พนักงาน
│   │   │   │   ├── RestockTab.jsx     # สั่งของ / ซื้อของเข้าร้าน
│   │   │   │   ├── ExpensesTab.jsx    # ค่าใช้จ่าย / สต๊อกแก้ว
│   │   │   │   ├── AdminPanel.jsx     # สมาชิก, เมนู, topping, LINE config
│   │   │   │   ├── MyProfileScreen.jsx
│   │   │   │   └── LoginScreen.jsx
...
│   │   │   │   ├── CustomizeModal.jsx
│   │   │   │   ├── VoiceCommandBar.jsx
│   │   │   │   ├── StaffAttendancePanel.jsx
│   │   │   │   ├── StaffAttendanceCleanupPanel.jsx
│   │   │   │   ├── StaffGuidePanel.jsx
│   │   │   │   ├── StaffLangNudge.jsx
│   │   │   │   └── MemberAvatar.jsx
...
**หน้าที่หลัก:** POS ร้านน้ำ / เมนู / topping / ตะกร้า / ปิดยอด / ค่าใช้จ่าย / เติมของ / สต๊อกแก้ว / พนักงาน / payroll / กำไร / รองรับ TH-MY-EN
...
|---|---|
| `lineWebhook` | รับข้อความ LINE ฝั่งกุ้ง |
| `lineWebhookTea` | endpoint ฝั่งชา / health / future LINE flow |
| `teaPushSummary` | ส่งสรุปปิดวันร้านชา |
| `parseLineOrder.js` | แปลงข้อความลูกค้าเป็น order |
| `webhookDedup.js` | กัน LINE event ซ้ำ |
| `shrimpDailySummary.js` | สรุปยอดกุ้ง |
| `teaDailySummary.js` | สรุปยอดชา |
