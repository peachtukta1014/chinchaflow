...
พีช (Peach) คือเจ้าของธุรกิจ 2 ร้าน: **ชินชา** (ร้านชานมไข่มุกของแฟนเป็นซุ้มชาชงเล็กๆวันละ50-150แก้ว/วัน) + **โกอ้วน** (พ่อค้าคนกลางค้าส่งกุ้งแม่น้ำตัวเป็น/และน้องสาวดูแลขายปลีกหน้าแผงตามตลาดนัดตัวตาย)

- **ความรู้โปรแกรมเมอร์ตั้งต้น = ศูนย์** — พีชไม่ใช่นักพัฒนา แต่เป็นคนมีวิสัยทัศน์
- **ทำคนเดียวทั้งหมด** — ไม่มีทีม ระหว่างดูแลฟาร์มที่เป็นบ่อพักและจัดส่งลูกค้าในชีวิตประจำวัน
